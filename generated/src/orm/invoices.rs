...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::InvoiceDate => ColumnType::DateTime.def(),
            Self::BillingAddress => ColumnType::String(None).def().null(),
            Self::BillingCity => ColumnType::String(None).def().null(),
            Self::BillingState => ColumnType::String(None).def().null(),
            Self::BillingCountry => ColumnType::String(None).def().null(),
            Self::BillingPostalCode => ColumnType::String(None).def().null(),
            Self::Total => ColumnType::Decimal(None).def(),
        }
    }
}
