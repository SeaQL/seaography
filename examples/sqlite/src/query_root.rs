...
use seaography::{
    Builder, BuilderContext, EntityObjectRelationBuilder,
    EntityObjectViaRelationBuilder,
};
...
pub fn schema(
    ...
    let builder =
        ...
        entity_object_relation_builder.get_relation::<
    ...
    let builder = builder.register_entity::<crate::entities::rental::Entity>(vec![
    ...
    let builder = builder.register_entity::<crate::entities::category::Entity>(vec![
    ...
    let builder = builder.register_entity::<crate::entities::staff::Entity>(vec![
        entity_object_relation_builder
    ...
    let builder = builder.register_entity::<crate::entities::country::Entity>(vec![
        entity_object_relation_builder
    ...
    let builder = builder.register_entity::<crate::entities::film::Entity>(vec![
        entity_object_via_relation_builder
    ...
    let builder = builder.register_entity::<crate::entities::actor::Entity>(vec![
        entity_object_via_relation_builder
            .get_relation::<crate::entities::actor::Entity, crate::entities::film::Entity>("Film"),
    ]);

    let builder = builder.register_entity::<crate::entities::city::Entity>(vec![
    ...
    let builder = builder.register_entity::<crate::entities::language::Entity>(vec![
        entity_object_relation_builder.get_relation::<
            crate::entities::city::Entity,
            crate::entities::address::Entity,
        >("Address", crate::entities::city::Relation::Address.def()),
    ...
    let builder = builder.register_entity::<crate::entities::inventory::Entity>(vec![entity_object_relation_builder.get_relation::<
    ...
    let builder = builder.register_entity::<crate::entities::film_text::Entity>(vec![]);

    let builder = builder.register_entity::<crate::entities::film_category::Entity>(vec![entity_object_relation_builder.get_relation::<
    ...
    let builder = builder.register_entity::<crate::entities::customer::Entity>(vec![entity_object_relation_builder.get_relation::<
    ...
    let builder = builder.register_entity::<crate::entities::store::Entity>(vec![entity_object_relation_builder.get_relation::<
        crate::entities::store::Entity,
        crate::entities::address::Entity,
    ...
    let builder = builder.register_entity::<crate::entities::payment::Entity>(vec![entity_object_relation_builder.get_relation::<
        crate::entities::payment::Entity,
        crate::entities::customer::Entity,
    >(
        "Customer",
    ...
    let builder = builder.register_entity::<crate::entities::address::Entity>(vec![entity_object_relation_builder.get_relation::<
        crate::entities::address::Entity,
        crate::entities::city::Entity,
