...
impl Model {
    pub async fn staff_id(&self) -> &i32 {
        &self.staff_id
    }
...
pub struct Filter {
    ...
    pub staff_id: Option<TypeFilter<i32>>,
    ...
    pub active: Option<TypeFilter<bool>>,
