...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            Self::StaffId => ColumnType::Integer.def(),
            ...
            Self::Username => ColumnType::String(Some(16u32)).def(),
            Self::Password => ColumnType::String(Some(40u32)).def().null(),
            Self::LastUpdate => ColumnType::DateTime.def(),
            Self::Picture => ColumnType::Binary.def().null(),
        }
    }
}
